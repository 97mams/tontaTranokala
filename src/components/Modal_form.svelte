    ...
    <div class="modal-box">
      <form method="POST" use:enhance>
        ...
        <fieldset class="fieldset">
          ...
          <textarea name="description" class="textarea h-24" placeholder="Déscription">lorem impsum dolor st</textarea>
        </fieldset>
        <button type="submit" class="btn btn-sm btn-outline btn-secondary" onclick={my_modal_1.close()}>enregister</button>
      </form>
    </div>
  </div>
</dialog>