import { n as api, r as authClient } from "./router-BD2KnyJz.js";
import { i as cn, r as Button, t as Logo } from "./navbar-Cyj_Tx2Y.js";
import { s as Separator } from "./card-Cb5TNtmM.js";
	...
	return /* @__PURE__ */ jsxs(Sidebar, {
		...
		children: [
			...
			/* @__PURE__ */ jsxs(SidebarContent, { children: [
				...
				/* @__PURE__ */ jsxs(SidebarGroup, { children: [/* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Bibliothèque" }), /* @__PURE__ */ jsxs(SidebarMenu, { children: [disabledItems.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(SidebarMenuButton, {
					disabled: true,
				...
				}) }, item.label)), /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(SidebarMenuButton, {
					render: /* @__PURE__ */ jsx(Link, { to: "/history" }),
					tooltip: "Historique",
					isActive: pathname === "/history",
					children: [/* @__PURE__ */ jsx(History, {}), /* @__PURE__ */ jsx("span", { children: "Historique" })]
				}) })] })] })
			] }),
